...
async function createEvent(eventName='sblviii-ml', startDate=1707694200000, odds=[0.5, 0.5], multiplier=1, options=["Chiefs-ML", "49ers-ML"], prompt="Who will win the Super Bowl?") {
