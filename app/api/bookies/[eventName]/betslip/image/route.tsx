            ...
            <div style={{display: 'flex', flexDirection:'row', height:'100%', width:'100%'}}>
                <div style={{
                    ...
                    <div style={{display: 'flex', width:'75%', height:'57%', flexDirection: 'column', alignSelf:'center', alignItems:'flex-start', flexWrap: 'wrap', padding:10}}> 
                        ...
                        <h1 style={{color: 'white', fontSize:30, margin:15}}>{stake} <img style={{width: 35, height: 35, marginLeft:10, marginRight:10}}src={`${process.env['HOST']}/usdc.png`}/></h1>
                        <h1 style={{color: 'white', fontSize:30, margin:15}}>{payout} <img style={{width: 35, height: 35, marginLeft:10, marginRight:10}}src={`${process.env['HOST']}/usdc.png`}/></h1>
                    </div>
