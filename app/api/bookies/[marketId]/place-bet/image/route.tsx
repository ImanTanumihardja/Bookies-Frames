        ...
        let imageResponse =  new ImageResponse(
            <div style={{display: 'flex', flexDirection:'row', height:'100%', width:'100%'}}>
                <div style={{
                    ...
                    {balance !== null && <h3 style={{color: 'white', position: 'absolute', bottom: 0, right:20, fontSize: 25, textAlign:'center'}}> <img style={{width: 25, height: 25, marginRight:5, marginTop: 5}}src={`${process.env['NEXT_PUBLIC_HOST']}/${symbol}.png`}/> {balanceString} </h3>}
