...
export async function GET(req: NextRequest) {
    let html;
    try {
        const {isFollowing, amount, prediction, streak, multiplier, timestamp, odds, options, balance, poll, prompt} = getRequestProps(req, [RequestProps.IS_FOLLOWING, RequestProps.STAKE, RequestProps.PREDICTION, RequestProps.STREAK, RequestProps.MULTIPLIER, RequestProps.TIMESTAMP, RequestProps.ODDS, RequestProps.OPTIONS, RequestProps.BALANCE, RequestProps.POLL, RequestProps.PROMPT]);
