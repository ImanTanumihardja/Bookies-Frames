...
export async function GET(req: NextRequest): Promise<Response> {
  ...
  const imageUrl:string = generateUrl(`api/frames/bookies/${FrameNames.EVENT}/image`, {[RequestProps.EVENT_NAME]: eventName, [RequestProps.TIME]: startDate}, true)
  ...
  const frame : Frame = {
    ...
    image: imageUrl,
    postUrl: generateUrl(`api/frames/bookies/${FrameNames.PLACE_BET}`, {[RequestProps.EVENT_NAME]: eventName}, false),
  };
