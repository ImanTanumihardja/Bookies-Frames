  ...
  return (
    <main>
      ...
      <p>
        ...
        PLEASE BE AWARE THAT THESE TERMS OF USE REQUIRE THE USE OF ARBITRATION ON AN INDIVIDUAL BASIS TO RESOLVE DISPUTES, RATHER THAN JURY TRIALS OR CLASS ACTIONS, AND ALSO LIMIT THE REMEDIES AVAILABLE TO YOU IN THE EVENT OF A DISPUTE.
      ...
      <h2 className="text-lg md:text-xl lg:text-3xl font-display font-bold mb-5 mt-10"> 2. AMENDMENTS </h2>
      <p>
      ...
      <h2 className="text-lg md:text-xl lg:text-3xl font-display font-bold mb-5 mt-10"> 3. DEFINITIONS AND INTERPRETATION </h2>
      <p>
      ...
      <ul className="list-disc list-inside ml-4">
        ...
        <li className="mb-2">
          "Applicable Law" means the laws of the State of New York as the same may be amended, modified, supplemented and in effect from time to time during the Term (as defined below).
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          "Ecosystem" means the Ethereum or other blockchain ecosystem under the name of the Company that will initially consist of a predictions market making protocol, and other features to be determined by the Company and its Affiliates.
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          "Wallet" means an Ethereum-based electronic wallet, such as that provided by Phantom, which allows Users to purchase and store cryptocurrencies and other tokens, and sign/engage in transactions on the Ethereum Blockchain, or any other supported wallet which provides similar functionality on the Ethereum Blockchain.
        </li>
      </ul>


      <h2 className="text-lg md:text-xl lg:text-3xl font-display font-bold mb-5 mt-10"> 4. CONDITIONS OF USE </h2>
      <p>User Representations and Warranties. As a condition to accessing or using the Services, you represent and warrant to the Company the following:</p>
      <ul className="list-disc list-inside ml-4">
        <li className="mb-2">
        ...
        <li className="mb-2">
          You must not be a resident, citizen or agent of, or incorporated in, and do not have a registered office in Cuba, North Korea, Iran, Libya, Iran, Lebanon, Central African Republic, Sudan, Syria, Somalia, Venezuela, Yemen, Russia, Myanmar (Burma), the regions of Crimea, Donetsk or Luhansk, or any other country or region that is the subject of comprehensive country-wide or region-wide economic sanctions by the United States (collectively, "Restricted Territories").
        </li>
        <li className="mb-2">
