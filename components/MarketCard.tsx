...
const MarketCard: FunctionComponent = () => {
    return (
        <div
        className={`h-[260px] w-[640px] rounded-xl bg-gray-200 flex flex-col items-end justify-start py-[19px] px-[22px] box-border gap-[16px] text-left text-smi text-white font-inter`}
      >
